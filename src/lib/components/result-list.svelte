...
<section class="flex flex-col gap-2">
	...
	<div class="flex flex-col gap-1">
		<div class="flex max-w-full grow flex-row gap-2">
			<Button
				variant="outline"
				disabled={show_as === "Web"}
				onclick={pushHead}
				size="sm"
				class="grow text-xl font-bold"><Plus strokeWidth={3} /></Button
			>
			<Button
				variant="outline"
				disabled={show_as === "Web"}
				onclick={popHead}
				size="sm"
				class="grow text-xl font-bold"><Minus strokeWidth={3} /></Button
			>
			<Button
				variant="secondary"
				disabled={show_as === "Web"}
